...
public class ScenesAdapter extends RecyclerView.Adapter<ScenesAdapter.ViewHolder> {
    ...
    Context context;
    public List<Scene> fields = new ArrayList<>();
    EventListener listener;
    public ScenesAdapter(Context context, List<Scene> data, EventListener listener) {
    ...
    public void setDataList(List<Scene> data){
        fields.clear();
        fields.addAll(data);
